		...
		<Navbar collapseOnSelect expand='md' bg='' variant='white'>
			...
			<Navbar.Collapse id='responsive-navbar-nav'>
				<Nav className='mr-auto'>
					<h3>Hello!</h3> <Link to='/signup'>Sign up/Log in</Link>
					...
					<Nav.Link className='Links' href='/favquotes'>
						Favorite Quotes
					</Nav.Link>
					<Nav.Link className='Links' href='/wishlist'>
						Wish List
					</Nav.Link>
					<Nav.Link className='Links' href='/completedlist'>
						Completed List
					</Nav.Link>
					<Nav.Link className='Links' href='/likeditems'>
						Liked items
					</Nav.Link>
